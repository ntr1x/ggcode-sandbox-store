...
import com.example.gateway.customers.config.GatewayCustomersConfig;
...
@ComponentScan(basePackageClasses = GatewayCustomersConfig.class)
@EnableJpaRepositories
public class GatewayCustomersSuite {
}
