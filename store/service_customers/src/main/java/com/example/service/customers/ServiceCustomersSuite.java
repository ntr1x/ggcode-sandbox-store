...
import com.example.service.customers.config.ServiceCustomersConfig;
...
@ComponentScan(basePackageClasses = ServiceCustomersConfig.class)
@EnableJpaRepositories
public class ServiceCustomersSuite {
}
